					...
					<>
						<div className="text-center mb-10 fade-up">
							...
							<p className="text-[var(--muted)] text-lg max-w-xl mx-auto leading-relaxed">
								Research any startup in seconds. Map their team. Generate
						...
						<form
							...
							className="w-full max-w-xl fade-up delay-1"
						>
							...
							>
								...
								<div>
									...
									<p className="text-xs text-[var(--muted)] mb-2">
										You've used your 2 searches for today. Resets at midnight
										UTC.
									</p>
									{AUTH_ENABLED && (
										<button
