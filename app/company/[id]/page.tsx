					...
					<div className="flex flex-col lg:flex-row lg:items-start gap-6">
						...
						<div className="flex-1">
							<div className="flex flex-wrap items-center gap-3 mb-1">
								<h1 className="text-2xl font-semibold text-[var(--brown-3)]">
									{company.name}
								</h1>
							...
							{company.mission && (
								<div
									className="inline-flex items-start gap-2 px-4 py-3 rounded-xl text-sm"
									style={{
										background: "var(--cream-2)",
										border: "1px solid var(--border)",
									}}
								>
									...
									<span className="text-[var(--brown-3)]">
										{company.mission}
									</span>
								</div>
							)}
						...
						<div className="surface p-6 fade-up delay-1">
							...
							<ul className="space-y-2.5">
								{company.recent_news.map((n, i) => (
									<li
										key={i}
										className="flex items-start gap-2 text-sm text-[var(--brown-3)]"
									>
										<span
				...
				<div className="surface overflow-hidden fade-up delay-3">
					...
					{activeTab === "tree" ? (
						<div className="flex flex-col lg:flex-row">
							<div
								className="flex-1 h-[380px] lg:h-[540px] p-2"
								style={{ background: "var(--cream)" }}
							>
								<OrgTree
									company={{
								...
								>
									...
									<div className="flex items-start gap-3">
										<div
											...
											style={{
												background: `${dotColor[selectedPerson.category]}18`,
												color: dotColor[selectedPerson.category],
											}}
										>
											{selectedPerson.name
												.split(" ")
										...
										<div>
											...
											<span className="pill mt-1">
												{categoryLabels[selectedPerson.category]}
											</span>
										</div>
									</div>
									...
									{selectedPerson.email && (
										...
										>
											...
											<span
												...
												style={{ background: "#EDF7ED", color: "#2D6A2D" }}
											>
												verified
											</span>
										</a>
								...
								>
									<div className="flex items-center gap-2.5 mb-2">
										<div
											...
											style={{
												background: `${dotColor[person.category]}18`,
												color: dotColor[person.category],
											}}
										>
											{person.name
												.split(" ")
										...
										<div className="min-w-0">
											<p className="text-sm font-medium text-[var(--brown-3)] truncate">
												{person.name}
											</p>
					...
					>
						<div className="surface flex items-center gap-3 px-4 py-3 rounded-2xl flex-wrap justify-between">
							<div className="flex items-center gap-2.5">
								<div
									className="w-7 h-7 rounded-lg flex items-center justify-center font-medium text-xs shrink-0"
									style={{
										background: `${dotColor[selectedPerson.category]}18`,
										color: dotColor[selectedPerson.category],
									}}
								...
								<div>
									<span className="text-sm font-medium text-[var(--brown-3)]">
										{selectedPerson.name}
									</span>
									<span className="text-xs text-[var(--muted)] ml-2 hidden sm:inline">
										{selectedPerson.role}
									</span>
								</div>
							</div>
